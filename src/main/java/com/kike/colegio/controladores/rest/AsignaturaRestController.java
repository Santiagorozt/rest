...
public class AsignaturaRestController {
	...
	public Iterable<AsignaturaEntity> listarTodosAsignaturas(){
	...
	public List<AsignaturaDTO> listarAsignaturasPorIdNombre(@RequestParam(value = "id", required = false) Integer id , 
